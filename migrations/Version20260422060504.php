...
final class Version20260422060504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE starship_droid ADD id INT AUTO_INCREMENT NOT NULL, ADD assigned_at DATETIME DEFAULT NOW() NOT NULL, CHANGE starship_id staship_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE starship_droid ADD CONSTRAINT FK_1C7FBE88AB064EF FOREIGN KEY (droid_id) REFERENCES droid (id)');
        $this->addSql('ALTER TABLE starship_droid ADD CONSTRAINT FK_1C7FBE8810C08A12 FOREIGN KEY (staship_id) REFERENCES starship (id)');
        $this->addSql('CREATE INDEX IDX_1C7FBE8810C08A12 ON starship_droid (staship_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE starship_droid DROP id, DROP assigned_at, CHANGE staship_id starship_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (starship_id, droid_id)');
